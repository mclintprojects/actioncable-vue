!(function (t, e) {
      ...
      !(function (t) {
        var e = { logger: self.console, WebSocket: self.WebSocket },
          ...
          l = (function () {
            function t(e) {
              i(this, t),
                (this.visibilityDidChange = this.visibilityDidChange.bind(
                  this
                )),
                (this.connection = e),
            ...
            return (
              ...
              (t.prototype.connectionIsStale = function () {
                return (
                  c(this.pingedAt ? this.pingedAt : this.startedAt) >
                  this.constructor.staleThreshold
                );
              }),
              (t.prototype.disconnectedRecently = function () {
                return (
                  this.disconnectedAt &&
                  c(this.disconnectedAt) < this.constructor.staleThreshold
                );
              }),
          ...
          f = (function () {
            ...
            return (
              ...
              (t.prototype.open = function () {
                return this.isActive()
                  ...
                  : (n.log(
                    ...
                    (this.webSocket = new e.WebSocket(this.consumer.url, a)),
              ...
              (t.prototype.isProtocolSupported = function () {
                return d.call(p, this.getProtocol()) >= 0;
              }),
  ...
  (t = e) &&
    ...
    t.default;
  var n = e.createConsumer;
  class o {
    _debug;
    _debugLevel;
    constructor(t, e) {
      (this._debug = t), (this._debugLevel = e);
    }
    log(t, e = "error") {
      this._debug &&
  ...
  var i = {
    mounted() {
      this.$options.channels &&
        Object.entries(this.$options.channels).forEach((t) => {
          if ("computed" != t[0]) this.$cable._addChannel(t[0], t[1], this);
          else {
            t[1].forEach((t) => {
              const e = t.channelName(),
                n = {
              ...
              (this.$options.channels[e] = n),
                this.$cable._addChannel(e, n, this);
            });
          }
        });
    },
    destroyed() {
      this.$options.channels &&
        Object.keys(this.$options.channels).forEach((t) =>
          this.$cable._removeChannel(t)
        );
    },
  };
  class s {
    ...
    _connectionUrl = null;
    constructor(t, e) {
      (t.prototype.$cable = this), t.mixin(i);
      let {
        debug: n,
        debugLevel: s,
        connectionUrl: r,
        connectImmediately: c,
      } = e || { debug: !1, debugLevel: "error", connectionUrl: null };
      (this._connectionUrl = r),
        !1 !== c && (c = !0),
        (this._logger = new o(n, s)),
        c && this._connect(this._connectionUrl);
    }
    subscribe(t, e) {
      if (this._cable) {
        const n = this,
          o = e || t.channel;
        this._channels.subscriptions[o] = this._cable.subscriptions.create(t, {
          connected() {
      ...
      } else this._connect(this._connectionUrl), this.subscribe(t, e);
    }
    perform(t) {
      const { channel: e, action: n, data: o } = t;
      this._logger.log(`Performing action '${n}' on channel '${e}'.`, "info");
      const i = this._channels.subscriptions[e];
      if (!i)
        throw new Error(
          `You need to be subscribed to perform action '${n}' on channel '${e}'.`
        );
      i.perform(n, o),
        this._logger.log(`Performed '${n}' on channel '${e}'.`, "info");
    }
    unsubscribe(t) {
      this._channels.subscriptions[t] &&
        (this._channels.subscriptions[t].unsubscribe(),
        this._logger.log(`Unsubscribed from channel '${t}'.`, "info"));
    }
    _channelConnected(t) {
      t.connected && t.connected.call(this._contexts[t._uid].context),
        this._logger.log(
          `Successfully connected to channel '${t._name}'.`,
          "info"
        );
    }
    _channelDisconnected(t) {
      t.disconnected && t.disconnected.call(this._contexts[t._uid].context),
        this._logger.log(
          `Successfully disconnected from channel '${t._name}'.`,
          "info"
        );
    }
    _subscriptionRejected(t) {
      t.rejected && t.rejected.call(this._contexts[t._uid].context),
        this._logger.log(`Subscription rejected for channel '${t._name}'.`);
    }
    _channelReceived(t, e) {
      t.received && t.received.call(this._contexts[t._uid].context, e),
        this._logger.log(`Message received on channel '${t._name}'.`, "info");
    }
    _connect(t) {
      if ("string" == typeof t) this._cable = n(t);
      else {
    ...
    _removeChannel(t) {
      if (this._channels.subscriptions[t]) {
        const e = this._channels[t]._uid;
        this._channels.subscriptions[t].unsubscribe(),
          delete this._channels[t],
          delete this._channels.subscriptions[t],
          --this._contexts[e].users,
          this._contexts[e].users <= 0 && delete this._contexts[e],
          this._logger.log(`Unsubscribed from channel '${t}'.`, "info");
      }
    }
    _fireChannelEvent(t, e, n) {
      if (this._channels.hasOwnProperty(t)) {
        const o = this._channels[t];
        e.call(this, o, n);
      }
    }
  }
